...
export const featured = [{
    ...
    name: "Plumber",
    total: "See Rate & Book",
    path: "/plumbing-services-in-kathmandu/",
},
{
    cover: "../images/services/electician.png",
    name: "Electrician",
    total: "See Rate & Book",
    path: "/electrician-services-in-kathmandu/",
},
{
    cover: "../images/services/applience.png",
    name: "Electrical Appliance",
    total: "See Rate & Book",
    path: "/electrical-appliance-in-kathmandu/",
},
{
    cover: "../images/services/motor.png",
    name: "Motor ",
    total: "See Rate & Book",
    path: "/motor-pumps-in-kathmandu",
},
{
    cover: "../images/services/painter.png",
    name: "Painting",
    total: "See Rate & Book",
    path: "/house-painting-in-kathmandu/",
},
{
    cover: "../images/services/carpenter.png",
    name: "Carpenter",
    total: "See Rate & Book",
    path: "/carpenter-services-in-kathmandu/",
},
{
    cover: "../images/services/naksa.png",
    name: "Ghar Naksa",
    total: "See Rate & Book",
    path: "/ghar-naksa-in-kathmandu",
},
{
...
},
{
    ...
    total: "See Rate & Book",
    path: "/house-repair-and-maintenance",
},
]
  ...
  export const price = [
    {
      ...
      list: [
        ...
        {
          icon: <i class='fa-solid fa-check'></i>,
          text: "Additonal cost for installations of sanitory and cp Items  ",
        },
          {
          icon: <i class='fa-solid fa-check'></i>,
          text: "Additonal cost for installations of sanitory and cp Items  ",
